...
use App\Models\SFormularioSectorEmpresa;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Log;

class SFormularioSectorEmpresaController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        try {
            ...
            $formulario=SFormularioSectorEmpresa::create([
    ...
    {
        $formulario_sector=SFormularioSectorEmpresa::where('id_formulario',$id)->
        with('sector')->get();
    ...
    {
        $formulario_sector=SFormularioSectorEmpresa::where('id_sector',$id)->
        with('formulario')->get();
