                        ...
                        <tbody>
                            <tr v-for="item in formularios" :key="item.id">
                                ...
                                <td class="celda">
                                   ...
                                   <div class="col-auto">
                                    <router-link  
                                        :to="{ name: 'sectores.formularios.s', params: { 'id': item.id } }"
                                   ...
                                   <div class="col-auto">
                                    <router-link  
                                        :to="{ name: 'secciones.formularios', params: { 'id': item.id } }"
                                        class="btn app-btn-primary "
                                        >
                                        <i class="fas fa-plus fa-fw"></i>  Secciones 
                                    </router-link>
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        ...
        async cargarFormularios(){
            const res = await sFormularioService.index();
        ...
        async guardar(){  
            ...
            if(this.v$.$error){
                ...
                if(this.modificar){
                    ...
                    await sFormularioService.update(formulario);
                    this.modalHide();
                    ...
                    await sFormularioService.store(formulario);
